  ...
  return (
    <main className="relative min-h-screen bg-background text-foreground p-4 md:p-8 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 animate-pulse opacity-5 pointer-events-none">
        <div className="w-[120%] h-[120%] bg-gradient-radial from-blue-400 via-transparent to-transparent rounded-full blur-3xl mx-auto mt-[30%]" />
      </div>
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <header className="space-y-12">
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg text-muted-foreground">
              Hi, I’m Myke, a Software Engineer passionate about databases and
              distributed systems. I'm currently exploring Apache Pinot 🍷, a
              real-time OLAP database built for ultra-low-latency analytics at
              {/* scale.
              — contributing to real-time analytics, indexing
              strategies,and execution planning. */}
            </p>
            {/* <p className="text-muted-foreground">
              I enjoy unraveling how data flows beneath the surface — from
              storage engines to query lifecycles — and love building tools that
              make data systems faster and more expressive. I actively
              contribute to open-source projects in the data systems space.
            </p>
            <p className="text-muted-foreground">
              I also write about system design, and building resilient
              infrastructure. Soon, I hope to share insights through talks and
        ...
        {/* <section className="space-y-2">
          ...
          <div className="text-muted-foreground space-y-2">
            <p>
              Final-year B.Sc Computer Science and Engineering student at
              Obafemi Awolowo University (OAU), Nigeria. My academic journey has
              blended theory and practice, with a strong focus on systems
              programming, data structures, and scalable computing.
            </p>
            <p>
              Additionally, I’m taking both Introductory and Advanced Database
              Systems courses from Carnegie Mellon University (CMU), diving deep
              into storage engines, indexing, concurrency, and query planning.
            </p>
          </div>
        </section> */}
